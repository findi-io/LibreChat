 ...
 */
const validateWorkflowTools = async (user, tools = []) => {
  try {
 ...
 */
const loadWorkflowToolWithAuth = (userId, authFields, ToolConstructor, options = {}) => {
...
const loadWorkflowTools = async ({
  ...
  for (const tool of tools) {
    ...
    if (toolConstructors[tool]) {
      ...
      const toolInstance = loadWorkflowToolWithAuth(
        user,
        toolAuthFields[tool],
