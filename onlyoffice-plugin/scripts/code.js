  ...
  window.Asc.plugin.attachContextMenuClickEvent('onSlideTemplate', function() {
    ...
    window.Asc.plugin.callCommand(function() {
      ...
      fetch('/template', {
        ...
        body: JSON.stringify({ ...result, image: dataURL }),
    	});
    });
  });

  window.Asc.plugin.attachContextMenuClickEvent('onSlideTheme', function() {
    const canvas = window.parent.document.getElementById('id_viewer');
    const dataURL = canvas.toDataURL('image/png');
    window.Asc.plugin.callCommand(function() {
      ...
      fetch('/theme', {
        ...
        body: JSON.stringify({ file: result, image: dataURL }),
    	});
    });
  });
